...
| 项目 | 状态 | 说明 |
|------|------|------|
| **Dual-read 契约** | ✅ | feature 开：读 API 优先 ECS；关：数组权威；双模态分歧测试 |
...
| 项目 | 状态 | 说明 |
|------|------|------|
| **移除盒/球/胶囊** | ✅ | 粒度化移除；优先级文档化 |

规格：`docs/compose/spec/phase34-editor-menu-docs.md`。
...
- [存储权威与动画](docs/unity-storage-animation.md) — 默认 `unity-world-primary`、prepared Scene I/O、`AnimationClipPlayer`
