...
pub fn draw(state: &EditorState, painter: &egui::Painter, canvas_rect: Rect, h_scale: f32, _w_scale: f32) {
    let gizmo_center = Pos2::new(
        canvas_rect.right() - 100.0,
        canvas_rect.top() + 80.0,
    );
