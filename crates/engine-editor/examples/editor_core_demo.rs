...
fn demonstrate_undo_redo() {
    ...
    println!("初始状态: can_undo={}, can_redo={}", 
        command_manager.can_undo(), command_manager.can_redo());
    ...
    println!("执行后: can_undo={}, can_redo={}", 
        command_manager.can_undo(), command_manager.can_redo());
    
    println!("\n执行撤销:");
    command_manager.undo();
    println!("撤销后: can_undo={}, can_redo={}", 
        command_manager.can_undo(), command_manager.can_redo());
    
    println!("\n执行重做:");
    command_manager.redo();
    println!("重做后: can_undo={}, can_redo={}", 
        command_manager.can_undo(), command_manager.can_redo());
