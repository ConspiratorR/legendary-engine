...
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Use the triggering comment ID / thread anchor: `79de9324-37ab-4149-920a-68d9888b3b11`. If your reply depends on thread context, do not rely only on resumed session memory — first pull the triggering conversation with: `multica issue comment list 2774838e-fc54-4cc4-be38-c8fd097b5cf4 --thread 79de9324-37ab-4149-920a-68d9888b3b11 --tail 30 --output json`.

4. Find the triggering comment (ID: `79de9324-37ab-4149-920a-68d9888b3b11`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    # 2. Then run:
    multica issue comment add 2774838e-fc54-4cc4-be38-c8fd097b5cf4 --parent 79de9324-37ab-4149-920a-68d9888b3b11 --content-file ./reply.md
