...
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Use the triggering comment ID / thread anchor: `ed825f44-432d-4405-85a9-9bf50c69bac5`. If your reply depends on thread context, do not rely only on resumed session memory — first pull the triggering conversation with: `multica issue comment list cf5f24eb-7448-425e-b859-13fc70dcfc1b --thread ed825f44-432d-4405-85a9-9bf50c69bac5 --tail 30 --output json`.

4. Find the triggering comment (ID: `ed825f44-432d-4405-85a9-9bf50c69bac5`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    # 2. Then run:
    multica issue comment add cf5f24eb-7448-425e-b859-13fc70dcfc1b --parent ed825f44-432d-4405-85a9-9bf50c69bac5 --content-file ./reply.md
