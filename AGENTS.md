...
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Do not re-read comment history by default. Only if the resumed session is missing thread context, pull the triggering conversation: `multica issue comment list 668fe0f3-88e1-4e27-a04a-a34b5a810dcb --thread fd2cefdc-0c90-45c0-8cd1-64f0d81a1af2 --tail 30 --output json`.

4. Find the triggering comment (ID: `fd2cefdc-0c90-45c0-8cd1-64f0d81a1af2`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    # 2. Then run:
    multica issue comment add 668fe0f3-88e1-4e27-a04a-a34b5a810dcb --parent fd2cefdc-0c90-45c0-8cd1-64f0d81a1af2 --content-file ./reply.md
