...
1. Run `multica issue get 2774838e-fc54-4cc4-be38-c8fd097b5cf4 --output json` to understand the issue context
2. Run `multica issue metadata list 2774838e-fc54-4cc4-be38-c8fd097b5cf4 --output json` to see what prior agents pinned — best-effort, empty `{}` and CLI failures are normal. See the `## Issue Metadata` section above for what to look for.
3. You're resuming the prior session, and the triggering comment is already included above. No other new comments on this issue since your last run. Use the triggering comment ID / thread anchor: `2f9b4c37-508e-4dfe-981e-465ed388eb0a`. If your reply depends on thread context, do not rely only on resumed session memory — first pull the triggering conversation with: `multica issue comment list 2774838e-fc54-4cc4-be38-c8fd097b5cf4 --thread 2f9b4c37-508e-4dfe-981e-465ed388eb0a --tail 30 --output json`.

4. Find the triggering comment (ID: `2f9b4c37-508e-4dfe-981e-465ed388eb0a`) and understand what is being asked — do NOT confuse it with previous comments
...
Use this form, preserving the same issue ID and --parent value:
    ...
    # 2. Then run:
    multica issue comment add 2774838e-fc54-4cc4-be38-c8fd097b5cf4 --parent 2f9b4c37-508e-4dfe-981e-465ed388eb0a --content-file ./reply.md
